...
public class PlayerController {
    ...
    @GetMapping("/id/{id}")
    public ResponseEntity<PlayerOutputDto> getPlayerById(@PathVariable @NotEmpty Long id) {
        return new ResponseEntity<>(playerService.findById(id), HttpStatus.OK);
    }

    @GetMapping("/username")
    public ResponseEntity<PlayerOutputDto> getPLayerByUsername(@RequestParam @NotEmpty String username) {
    ...
    public ResponseEntity<PlayerOutputDto> updateTeam(@PathVariable @NotEmpty Long id, @PathVariable @NotEmpty String username) {
